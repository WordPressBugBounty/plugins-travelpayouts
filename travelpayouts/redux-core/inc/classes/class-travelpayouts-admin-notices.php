...
if (! class_exists('Redux_Travelpayouts_Admin_Notices', false)) {
    ...
    class Redux_Travelpayouts_Admin_Notices extends Redux_Travelpayouts_Class
    {
        ...
        public function __construct($parent)
        {
            ...
            add_action('wp_ajax_Redux_Travelpayouts_hide_admin_notice', [ $this, 'ajax' ]);
            add_action('admin_notices', [ $this, 'notices' ], 99);
            add_action('admin_init', [ $this, 'dismiss' ], 9);
        }
        ...
        public static function set_notice($data)
        {
            ...
            self::$notices[ $parent->args['page_slug'] ][] = [
                'type'    => $type,
                'msg'     => $msg,
        ...
        public function admin_notices($notices = [])
        {
            ...
            if (isset($_GET) && isset($_GET['page']) && $core->args['page_slug'] === $_GET['page']) { // phpcs:ignore WordPress.Security.NonceVerification
                ...
                self::$notices[ $core->args['opt_name'] ] = [];
            }
        }
