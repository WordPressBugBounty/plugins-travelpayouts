...
/**
 * Redux_Travelpayouts Validation Class
 *
 * @class   Redux_Travelpayouts_Validation
 * @version 4.0.0
...
if (! class_exists('Redux_Travelpayouts_Validation', false)) {

    /**
     * Class Redux_Travelpayouts_Validation
     */
    class Redux_Travelpayouts_Validation extends Redux_Travelpayouts_Class
    {
        /**
                    ...
                    foreach ($section['fields'] as $fkey => $field) {
                        ...
                        if (isset($field['validate'])) {
                            ...
                            foreach ($val_arr as $idx => $val) {
                                ...
                                $validate = 'Redux_Travelpayouts_Validation_' . $val;

                                if (! class_exists($validate)) {

                                    /**
                                     * Filter 'redux_travelpayouts/validate/{opt_name}/class/{field.validate}'
                                     *
                                    ...
                                    $class_file = apply_filters("redux_travelpayouts/validate/{$core->args['opt_name']}/class/{$val}", Redux_Travelpayouts_Core::$dir . "inc/validation/{$val}/class-travelpayouts-validation-{$file}.php", $validate);
