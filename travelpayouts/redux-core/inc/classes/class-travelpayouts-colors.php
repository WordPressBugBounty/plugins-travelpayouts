...
/**
 * Redux_Travelpayouts Color Manipulator Class
 *
...
if (! class_exists('Redux_Travelpayouts_Colors', false)) {

    /**
     * Class Redux_Travelpayouts_Colors
     */
    class Redux_Travelpayouts_Colors extends Redux_Travelpayouts_Class
    {
        /**
         ...
         * @return  array       returns array( 'h', 's', 'v' ).
         */
        public static function rgb_to_hsv($color = [])
        {
            $var_r = ($color[0] / 255);
            $var_g = ($color[1] / 255);
            $var_b = ($color[2] / 255);
