...
/**
 * Redux_Travelpayouts Descriptor Class
 *
 * @class Redux_Travelpayouts_Descriptor
 * @version 4.0.0
...
class Redux_Travelpayouts_Descriptor
{
    ...
    /**
     * Array of Redux_Travelpayouts_Descriptor_Fields.
     *
     * @var array Redux_Travelpayouts_Descriptor_Fields[] Array of descriptor_fields.
     */
    protected $fields = [];
    ...
    /**
     * Redux_Travelpayouts_Descriptor constructor.
     *
     * @param string $field Field name.
     */
    public function __construct($field)
    {
        Redux_Travelpayouts_Descriptor_Fields::$order = 0;
        try {
            $this->reflection_class = new ReflectionClass($field);
        } catch (ReflectionException $e) {
            die($e->getMessage()); // phpcs:ignore
        }
        $this->field_type = Redux_Travelpayouts_Core::strtolower(Redux_Travelpayouts_Helpers::remove_prefix($this->reflection_class->getShortName(), 'Redux_Travelpayouts_'));
     ...
     *
     * @return Redux_Travelpayouts_Descriptor_Fields
     */
    public function add_field($name, $title, $type, $description = '', $default = null)
    {
        try {
            $this->fields[ $name ] = new Redux_Travelpayouts_Descriptor_Fields($name, $title, $type, $description, $default);
        } catch (Exception $e) {
            return null;
        }
