...
/**
 * Redux_Travelpayouts Framework Private Extended Functions Container Class
 *
 * @class       Redux_Travelpayouts_Functions_Ex
 * @since       3.0.0
...
// Don't duplicate me!
if (! class_exists('Redux_Travelpayouts_Functions_Ex', false)) {
    ...
    class Redux_Travelpayouts_Functions_Ex
    {
        ...
        public static function record_caller($opt_name = '')
        {
            ...
            if (! empty($caller) && ! empty($opt_name) && class_exists('Redux_Travelpayouts_Core')) {
                if (! isset(Redux_Travelpayouts_Core::$callers[ $opt_name ])) {
                    Redux_Travelpayouts_Core::$callers[ $opt_name ] = [];
                }

                if (strpos($caller, 'class-travelpayouts-') !== false || strpos($caller, 'redux-core/framework.php')) {
                    return;
                }

                if (! in_array($caller, Redux_Travelpayouts_Core::$callers[ $opt_name ], true)) {
                    Redux_Travelpayouts_Core::$callers[ $opt_name ][] = $caller;
                }
        ...
        {
            add_action('wp_head', [ 'Redux_Travelpayouts_Functions_Ex', 'meta_tag' ]);
        }
        ...
        {
            echo '<meta name="framework" content="Redux_Travelpayouts ' . esc_html(Redux_Travelpayouts_Core::$version) . '" />';
        }
        ...
        /**
         * Is Redux_Travelpayouts embedded inside a plugin.
         *
        ...
        /**
         * Is Redux_Travelpayouts embedded in a theme.
         *
         * @param     string $file File to check.
         *
         * @return array|bool
        ...
        {
            $upload_dir = TravelpayoutsSettingsFramework::$_dir . '/extension_compatibility/';
            if (TRAVELPAYOUTS_DEBUG && ! file_exists($upload_dir . $ext_class . '.php')) {
                if (! is_dir($upload_dir)) {
                    $parent->filesystem->mkdir($upload_dir);
                    $parent->filesystem->put_contents($upload_dir . 'index.php', '<?php');
                }
                if (! class_exists($ext_class)) {
                    require_once $path;
                }
                if (TRAVELPAYOUTS_DEBUG && ! file_exists($upload_dir . $new_class_name . '.php')) {
                    $class_file = '<?php' . PHP_EOL . PHP_EOL .
                        'class {{ext_class}} extends Redux_Travelpayouts_Extension_Abstract {' . PHP_EOL .
                        '    private $c;' . PHP_EOL .
                        ...
                        '    }' . PHP_EOL .
                        '    // fake "extends Redux_Travelpayouts_Extension_Abstract\" using magic function' . PHP_EOL .
        ...
        /**
         * Check if Redux_Travelpayouts is activated.
         *
         * @access public
         * @since 4.0.0
         */
        ...
        {
            if (Redux_Travelpayouts_Core::$insights->tracking_allowed()) {
                return true;
            }
            return false;
        }
        ...
        /**
         * Set Redux_Travelpayouts to activated.
         *
         * @access public
         * @since 4.0.0
         */
        ...
        /**
         * Set Redux_Travelpayouts to deactivated.
         *
         * @access public
         * @since 4.0.0
         */
        ...
        {
            if (! class_exists('Redux_Travelpayouts_Autoloader')) {
                require_once Redux_Travelpayouts_Path::get_path('/inc/classes/class-travelpayouts-autoloader.php');
            }
            $loader = new Redux_Travelpayouts_Autoloader($prefix, $path);
