...
/**
 * Redux_Travelpayouts Select2 AJAX Class
 *
 * @class   Redux_Travelpayouts_AJAX_Select2
 * @version 4.0.0
...
if (! class_exists('Redux_Travelpayouts_AJAX_Select2', false)) {

    /**
     * Class Redux_Travelpayouts_AJAX_Select2
     */
    class Redux_Travelpayouts_AJAX_Select2 extends Redux_Travelpayouts_Class
    {
        /**
         * Redux_Travelpayouts_AJAX_Select2 constructor.
         *
        ...
        public function __construct($parent)
        {
            ...
            add_action("wp_ajax_Redux_Travelpayouts_{$parent->args['opt_name']}_select2", [ $this, 'ajax' ]);
        }
        ...
        public function ajax()
        {
            ...
            if (isset($_REQUEST['nonce']) && isset($_REQUEST['action'])) {
                ...
                if (! Redux_Travelpayouts_Helpers::current_user_can($this->parent->args['page_permissions'])) {
                    wp_send_json_error(esc_html__('Invalid user capability.  Please reload the page and try again.', 'redux-framework'));
                }

                if (isset($_REQUEST['data'])) {

                    $args = isset($_REQUEST['data_args']) ? json_decode(sanitize_text_field(wp_unslash($_REQUEST['data_args'])), true) : [];
                    $args = wp_parse_args(
                        $args,
                        [
