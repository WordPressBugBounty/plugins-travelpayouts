...
if (! class_exists('Redux_Travelpayouts_Page_Render', false)) {
    ...
    class Redux_Travelpayouts_Page_Render extends Redux_Travelpayouts_Class
    {
        ...
        public function __construct($parent)
        {
            ...
            add_action('admin' . '_bar' . '_menu', [ $this, 'add_menu' ], $parent->args['admin_bar_priority']);
            ...
            if ('network' === $parent->args['database'] && $parent->args['network_admin']) {
                add_action('network_admin_menu', [ $this, 'options_page' ]);
            }
        }
        ...
        public function options_page()
        {
            ...
            add_action("load-{$this->page}", [ $this, 'load_page' ]);
        }
         ...
         * @return      string
         */
        public function section_menu($k, $section, $suffix = '', $sections = [])
        {
            $core = $this->core();
