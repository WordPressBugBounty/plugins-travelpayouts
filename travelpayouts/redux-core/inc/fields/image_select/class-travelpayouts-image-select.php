...
// Don't duplicate me!
if (! class_exists('Redux_Travelpayouts_Image_Select', false)) {

    /**
     * Main Redux_Travelpayouts_image_select class
     *
     * @since       1.0.0
     */
    class Redux_Travelpayouts_Image_Select extends Redux_Travelpayouts_Field
    {
        /**
        ...
        public function enqueue()
        {
            ...
            wp_enqueue_script(
                ...
                Redux_Travelpayouts_Core::$url . 'inc/fields/image_select/redux-image-select' . Redux_Travelpayouts_Functions::is_min() . '.js',
                [ 'jquery', 'redux-js' ],
                $this->timestamp,
                true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    Redux_Travelpayouts_Core::$url . 'inc/fields/image_select/redux-image-select.css',
                    [],
                    $this->timestamp,
                    'all'
                );
...
class_alias('Redux_Travelpayouts_Image_Select', 'TravelpayoutsSettingsFramework_Image_Select');
